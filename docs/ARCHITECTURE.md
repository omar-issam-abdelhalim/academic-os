...
Dependency count is intentionally small: React, React Router, Dexie, dexie-react-hooks, Zod, Recharts (Stage 4), and (future) JSZip as runtime dependencies; Vite, vite-plugin-pwa, TypeScript, Vitest, Testing Library, fake-indexeddb, ESLint, Prettier as dev dependencies. No CSS framework is mandated by Stage 0 — that is a Stage 1 design-system decision.
